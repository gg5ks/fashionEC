...
/**
 * Servlet implementation class Product_UpdateExecute
 */
@WebServlet("/Product_UpdateExecute")
public class Product_UpdateExecute extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public Product_UpdateExecute() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //pdb.setMasterName(request.getParameter("masterName"));名前はなし
